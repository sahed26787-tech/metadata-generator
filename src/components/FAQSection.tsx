  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        {
          question: "What file formats does PixCraftAI support?",
          answer: "PixCraftAI supports a wide range of file formats including JPG, PNG, WebP, SVG, EPS, and even video files. Our platform automatically optimizes images for different social media platforms while maintaining the highest quality standards."
        }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "Yes! All images generated through PixCraftAI come with commercial usage rights. You can use them for marketing campaigns, social media posts, website content, advertisements, and any other commercial purposes without additional licensing fees."
        },
        {
          question: "What makes PixCraftAI different from other AI image generators?",
          answer: "PixCraftAI specializes in social media optimization, offering platform-specific image dimensions, batch processing capabilities, and advanced prompt engineering. Our AI is specifically trained for marketing and social media content, ensuring better engagement rates and professional quality."
        },
        {
      ...
      questions: [
        {
          ...
          answer: "PixCraftAI supports all major social media platforms including Instagram (posts, stories, reels), Facebook (posts, covers, ads), Twitter/X (posts, headers), LinkedIn (posts, banners), Pinterest (pins, boards), TikTok (videos, thumbnails), YouTube (thumbnails, banners), and many more. Each platform has optimized dimensions and formats."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "Yes! Our RESTful API allows developers to integrate PixCraftAI's image generation capabilities into their own applications, websites, or workflows. We provide comprehensive documentation, SDKs for popular programming languages, and dedicated developer support."
        },
        {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Everything you need to know about AI image generation, platform optimization, and getting the most out of PixCraftAI
          </p>
        </div>
