...
const PricingItem: React.FC<PricingItemProps> = ({ text, included, highlight }) => {
  return (
    <li className={`flex items-center space-x-3 ${highlight ? 'bg-[#1F71DC]/10 border border-[#1F71DC]/20 rounded-md px-2 py-1 -mx-2' : ''}`}>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12">
              ...
              <div className="relative group">
                <div className="bg-white border border-gray-200 rounded-xl p-6 h-full transition-all duration-200 hover:border-gray-300 shadow-sm">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-500">15 Credits for lifetime</p>
                    <div className="mt-4 px-3 py-1 bg-gray-100 rounded-full text-gray-600 text-xs inline-block">
                      Starter plan
                    </div>
                  </div>
              ...
              {/* Standard Plan */}
              <div className="relative group">
                <div className="bg-white border-2 border-[#1F71DC] rounded-xl p-6 h-full transition-all duration-200 hover:border-[#1F71DC] hover:shadow-lg shadow-md">
                  <div className="flex items-center space-x-3 mb-6">
                    <div className="w-7 h-7 rounded-lg bg-[#1F71DC]/10 flex items-center justify-center">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-500">5000 Credits</p>
                  </div>
                  ...
                  <button 
                    className="w-full bg-[#1F71DC] hover:bg-[#1a5cb8] text-white font-medium py-2.5 rounded-lg transition-colors duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
              ...
              <div className="relative group">
                <div className="bg-white border border-gray-200 rounded-xl p-6 h-full transition-all duration-200 hover:border-gray-300 shadow-sm">
                  <div className="flex items-center space-x-3 mb-6">
                    ...
                    <h3 className="text-lg font-medium text-gray-900">Exclusive</h3>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-500">15000 Credits</p>
                  </div>
                  ...
                  <button 
                    className="w-full bg-gray-900 hover:bg-gray-800 text-white font-medium py-2.5 rounded-lg transition-colors duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
            ...
            {activePlan && (
              <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
                <div className="w-full max-w-sm max-h-[86vh] rounded-xl border border-gray-200 bg-white text-gray-900 shadow-2xl flex flex-col">
                  <div className="flex items-center justify-between border-b border-gray-200 px-3 py-2.5">
                    <h2 className="text-base font-semibold">Complete Your Payment</h2>
                    <button
                      className="text-gray-500 hover:text-gray-700 transition-all duration-150 active:scale-95"
                  ...
                  <div className="p-3 space-y-2.5 overflow-y-auto pr-2">
                    <div className="rounded-lg bg-gray-50 border border-gray-200 p-2.5 flex items-center justify-between">
                      <div>
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-lg font-bold text-[#1F71DC]">৳{activePlan.amount}</p>
                      </div>
                    </div>

                    <div>
                      <p className="text-xs text-gray-600 mb-1.5">Select payment method</p>
                    ...
                    <div className="rounded-lg bg-gray-50 border border-gray-200 p-2.5">
                      <p className="text-xs text-gray-600 mb-1.5">Send to this number</p>
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-base font-bold tracking-wide text-gray-900">{walletNumberDisplay}</span>
                        <button
                          onClick={handleCopyWallet}
                          className="inline-flex items-center gap-1 rounded-md bg-gray-900 text-white px-2.5 py-1 text-xs font-semibold hover:bg-gray-800 transition-all duration-150 active:scale-95"
                        >
                    ...
                    <div className="rounded-lg border border-yellow-400 bg-yellow-50 p-2.5 text-xs text-yellow-800">
                    ...
                    <div>
                      <label className="block text-xs text-gray-600 mb-1">Transaction ID (TrxID) *</label>
                      <input
                        value={trxId}
                        onChange={(e) => setTrxId(e.target.value)}
                        placeholder="Enter your TrxID"
                        className="w-full rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm text-gray-900 outline-none focus:border-[#1F71DC]"
                      />
                    </div>

                    <div className="rounded-lg border border-gray-200 bg-gray-50 p-2.5">
                      <p className="text-xs font-semibold mb-1.5">Customer Details</p>
                      <p className="text-xs text-gray-600">Name: {customerName}</p>
                    ...
                    <button
                      ...
                      className="w-full rounded-md bg-green-600 hover:bg-green-700 text-white text-sm font-semibold py-2 transition-all duration-150 active:scale-95"
                    >
                      Verify on WhatsApp
                    </button>
                  </div>
